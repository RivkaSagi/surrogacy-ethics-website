 ...
 * Logo matches v4 proportions exactly
 * All elements move together during balance dance
 */

// V4 Logo exact proportions (scaled down for footer)
const SCALE = 0.5;
const LOGO = {
  // From v4: Big circle center (127, 120), r=60 - same as v2
  surrogate: { cx: 127 * SCALE, cy: 120 * SCALE, r: 60 * SCALE, rSmall: 45 * SCALE },
  // From v4: Upper circle center (170, 83), r=39 - moved down and left from v2
  parent: { cx: 170 * SCALE, cy: 83 * SCALE, r: 39 * SCALE },
  // From v4: Filled dot (159.8, 108.9), r=10 - larger and moved down
  baby: { cx: 159.8 * SCALE, cy: 108.9 * SCALE, r: 10 * SCALE, rGrown: 15 * SCALE },
  // From v4: Balance line and circles - circles are larger
  balance: {
    line: { x1: 28 * SCALE, y1: 103 * SCALE, x2: 287 * SCALE, y2: 180 * SCALE },
    left: { cx: 49.45 * SCALE, cy: 92.35 * SCALE, r: 7.35 * SCALE },
    right: { cx: 282.45 * SCALE, cy: 162.35 * SCALE, r: 7.35 * SCALE },
  },
};
